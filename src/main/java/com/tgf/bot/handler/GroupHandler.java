            ...
            switch (parts[1]) {
                ...
                case "set" -> {
                    ...
                    if (group.getPinnedAnnounceMsgId() != null) {
                        try {
                            bot.execute(new com.pengrad.telegrambot.request.UnpinChatMessage(chatId, group.getPinnedAnnounceMsgId()));
